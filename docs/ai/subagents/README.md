...
1. Planner creates or updates the task brief, preferably starting with `npm run workflow -- scaffold --slug <topic> --artifacts task|bundle`.
...
- prefer `npm run workflow -- scaffold` so filenames and linked paths stay aligned by default

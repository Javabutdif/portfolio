      ...
      <main className="max-w-5xl mx-auto px-6 md:px-12 pt-32 pb-24">
        ...
        >
          <div className="max-w-3xl">
            ...
            >
              I build scalable full-stack and AI-powered applications, combining
              modern web technologies, intelligent workflows, and user-focused
        ...
        <section className="py-24 border-b border-border-subtle" id="projects">
          <div className="mb-16 max-w-2xl">
            ...
            <p className="text-body">
              Recent projects include AI-powered education platforms, student
              organization systems, healthcare matchmaking solutions, and

...
const skills = [
  {
    ...
    items: [
      ...
      { name: "Prompt Engineering", icon: <ChatsCircle /> },
      { name: "Context Engineering", icon: <Stack /> },
      { name: "AI-Assisted Development", icon: <Brain /> },
      { name: "Documentation-Driven Development", icon: <BookOpen /> },
      { name: "Agentic Workflow Design", icon: <GitBranch /> },
      { name: "LLM Application Development", icon: <Circuitry /> },
    ],
  },
  {
    category: "Frontend",
    ...
    <section className="py-24 border-b border-border-subtle" id="skills">
      <div className="mb-16 max-w-2xl">
        ...
        <p className="text-body">
          A focused toolkit for building production-grade web applications.
          Emphasizing modern React ecosystems on the frontend and robust data
          pipelines on the backend.
        </p>
      </div>
